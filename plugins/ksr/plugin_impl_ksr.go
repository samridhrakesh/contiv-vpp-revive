...
//go:generate protoc -I ./model/pod --go-grpc_out=:./model/pod ./model/pod/pod.proto
//go:generate protoc -I ./model/namespace --go-grpc_out=:./model/namespace ./model/namespace/namespace.proto
//go:generate protoc -I ./model/policy --go-grpc_out=:./model/policy ./model/policy/policy.proto
//go:generate protoc -I ./model/service --go-grpc_out=:./model/service ./model/service/service.proto
//go:generate protoc -I ./model/endpoints --go-grpc_out=:./model/endpoints ./model/endpoints/endpoints.proto
//go:generate protoc -I ./model/node --go-grpc_out=:./model/node ./model/node/node.proto
//go:generate protoc -I ./model/ksrapi --go-grpc_out=:./model/ksrapi ./model/ksrapi/ksr_nb_api.proto
//go:generate protoc -I ./model/sfc --go-grpc_out=:./model/sfc ./model/sfc/sfc.proto
